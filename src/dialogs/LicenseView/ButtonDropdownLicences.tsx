              ...
              <Menu.Item>
                <DialogModal2
                  ...
                  children={
                    <>
                      <form action="#">
                        <div className="mb-5.5 grid grid-cols gap-5.5">
                          <div className="w-1/2">
                            {" "}
                            <CheckboxDefault
                              label={"Лицензия"}
                          ...
                          <div className="w-full">
                            <label
                              className="mb-3 block text-sm font-medium text-black text-left dark:text-white"
                              htmlFor="Report">
                              Вид отчета
                            </label>

                            <div className="relative">
                              <SelectCustom placeholder={"Не заполнено"} />
                            </div>
                          </div>
                          <div className="w-full">
                            <label
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    } group flex w-full items-center rounded-md px-2 py-2 text-sm hover:text-meta-5`}>
