...
export default function ModalIconSubjectAddressAdd(props: {
  name: string;
  title: string;
  textbutton: string;
  icon: ReactNode;
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                <Dialog.Panel className="w-full max-w-230 rounded-lg bg-white dark:bg-boxdark">
                  <ModalHeader>
                    {props.name}Добавление адреса субъекта
                    <button
                      type="button"
                  ...
                  <ModalBody>
                    ...
                    <form action="#">
                      <div className="mb-5.5 grid grid-cols-12 gap-4">
                        <div className="col-span-6 flex flex-col border border-stroke rounded-md p-2">
                          <div className="flex flex-row gap-4 text-xs text-black">
                            <CheckboxDefault
                              label={"Субъект РФ"}
                              name={""}
                              id={""}
