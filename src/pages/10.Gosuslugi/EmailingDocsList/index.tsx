...
const EmailingDocsList = ({token, personlog_id, resources}) => {
  ...
  return (
    <>
      ...
      />
      <Breadcrumb pageName="Рассылка предостережений" />
      <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <div className="col-span-12">
          <CardTable
            onFiltersClick={openFilters}
            name="Рассылка предостережений"
            buttons={
              <>
                <button
                    type="button"
...
export default EmailingDocsList;
