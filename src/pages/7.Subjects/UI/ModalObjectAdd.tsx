...
import ModalIconAddressAdd from "../../../dialogs/SubjectView/ModalIconObjectAddressAdd";

export default function ModalSubjectAdd(props: {
  title: string;
  textbutton: string;
  children: ReactNode;
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                <Dialog.Panel className="w-full max-w-230 rounded-lg bg-white dark:bg-boxdark">
                  <ModalHeader>
                    Объект лицензирования - добавление
                    <button
                      type="button"
