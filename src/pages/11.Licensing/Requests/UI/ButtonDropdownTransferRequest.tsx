...
import DialogModal2 from "../../../9.Okno/LicenseList/DialogModal2";

export default function ButtonDropdownTransferRequest() {
  return (
    <div className="w-56">
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    } group flex w-full items-center px-2 py-2 text-sm hover:text-meta-5`}>
                    Возврат дел в одно окно
                  </button>
                )}
              </Menu.Item>
              <Menu.Item>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    className={`${
                      active ? "bg-violet-500 text-white" : "text-gray-900"
                    } group flex w-full items-center px-2 pt-2 pb-3 text-sm hover:text-meta-5`}>
                    Результаты на выдачу
                  </button>
                )}
              </Menu.Item>
              <Menu.Item>
                {({ active }) => (
                  <button
                    className={`${
                      active ? "bg-violet-500 text-white" : "text-gray-900"
                    } group flex w-full items-center px-2 py-2 text-sm hover:text-meta-5 border-t border-stroke`}>
                    Руководителю
                  </button>
                )}
              </Menu.Item>
