...
import ButtonDropdown from "../../../components/UI/General/Buttons/ButtonDropdown3.tsx";
import ButtonDropdownLicences from "../../../dialogs/LicenseView/ButtonDropdownLicences.tsx";
import ModalSvgButton from "../../../components/UI/General/Modal/ModalSvgButton.tsx";
import IconButtonList from "../../../components/UI/General/Buttons/IconButtonList.tsx";
import ButtonDropdownIconPrint from "../../../components/UI/General/Buttons/ButtonDropdownIconPrint.tsx";
...
import ModalCautionRemains from "./ModalCautionRemains.tsx";
...
const CautionRemains = ({ token, personlog_id, resources }) => {
  ...
  const [DataColumns] = useState([
    ...
    },
    {
      enableValue: true,
      field: "fullsubjectname",
      headerName: "Дата контроля исполнения",
      resizable: true,
      sortable: true,
      filter: "agTextColumnFilter",
    },
  ...
  return (
    <>
      ...
      />
      <Breadcrumb pageName="Предостережения об остатках" />
      <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <div className="col-span-12">
          <CardTable
            onFiltersClick={openFilters}
            name="Предостережения об остатках"
            buttons={
              <>
                <IconButtonDownload
                  onClick={() => Download()}
                ...
                />
                {/* Модальное окно при нажатии на иконку "+" и "Карандаш"*/}
                ...
                <ModalCautionRemains
                  ...
                  onClickText={""}
                  onClickClassName={""}></ModalCautionRemains>
                ...
                {/* Модальное окно при нажатии на иконку "Документ" */}
                <DefaultIconModalWide
                  name={"Редактирование документа"}
                  title={"Редактирование документа"}
                  textbutton={undefined}
                  icon={<IconButtonDocument />}
                  children={
                    <>
                      {" "}
                      <form action="#">
                ...
                <ButtonDropdownIconPrint title="Печать" />
                ...
                <Link to="/subject-view" relative="path">
                  <div className="text-primary text-sm">
                    *просмотр субъекта*
                  </div>
                </Link>
                <Link
                  to="/licensing/caution-remains/license-view"
                  relative="path">
                  <div className="text-primary text-sm">
                    *просмотр лицензии*
                  </div>
