...
const DetailsLicense = () => {
  ...
  return (
    <>
      ...
      />
      <Breadcrumb pageName="Детальный просмотр лицензии" />
      <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <div className="col-span-12">
          <CardTable
            onFiltersClick={openFilters}
            name="Детальный просмотр лицензии">
            <>
              {/*Данные о лицензии*/}
              <div className="p-5.5 col-span-12 grid-grid-col gap-4">
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Серия:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Номер:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Дата создания:</p>{" "}
                  <div className="">*данные*</div>
                </div>

                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Рег. номер:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Юр. адрес:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Дата состояния:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Основание:</p>{" "}
                  <div className="">*данные*</div>
                </div>
                <div className="flex flex-row gap-4">
                  <p className="text-md text-black">Отправка:</p>{" "}
                  <div className="">*данные*</div>
                </div>
              </div>
            </>
