...
import ButtonDropdownRequestsCurrentDay from "../../../../../dialogs/RequestCurrentDay/ButtonDropdownRequestsCurrentDay.tsx";
import DefaultModalWide from "../../../../../components/UI/General/Modal/DefaultModalWide.tsx";
import ButtonGreen from "../../../../../components/UI/General/Buttons/ButtonGreen.tsx";
...
const Types = forwardRef(function Types(props, ref) {
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <div className="col-span-12">
          <CardTableSubheader
            name={
              <>
                <div className="flex flex-row gap-4">
                  <CheckboxDefault
                    label={"Получение"}
                    value={props.types.includes(1)}
                    onChange={() => props.setTypes(1)}
                  />
                  <CheckboxDefault
                    label={"Переоформление"}
                    value={props.types.includes(3)}
                    onChange={() => props.setTypes(3)}
                  />
                  <CheckboxDefault
                    label={"Продление"}
                    value={props.types.includes(5)}
                    onChange={() => props.setTypes(5)}
                  />
                  <CheckboxDefault
                    label={"прекращение"}
                    value={props.types.includes(7)}
                    onChange={() => props.setTypes(7)}
                  />
                </div>
              </>
            }
            ...
            headerButtons={
              <>
                <ButtonDropdownRequestsCurrentDay />
                <ButtonGreen>
                  <DefaultModalWide
                    title={"Передача документов процесса"}
                    textbutton={"Оформить передачу на экспертизу"}
                    children={
                      <>
                    ...
                    onClickText={"Передать"}
                    onClickClassName={""}></DefaultModalWide>
                </ButtonGreen>
                <button
                  type="button"
