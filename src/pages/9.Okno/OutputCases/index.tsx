...
const InputCases = ({ token, personlog_id, resources }) => {
  ...
  const onSearchClick = async () => {
    ...
    try {
      const result = await axios.post(
        variables.API_URL +
          `/Api/OutputCases/count_docs_list?personlog_id=${personlog_id}`,
        activeDataFilters,
        {
          headers: {
    ...
    return {
      getRows: async (params) => {
        ...
        try {
          const result = await axios.post(
            variables.API_URL +
              `/Api/OutputCases/export_docs_list?personlog_id=${personlog_id}`,
    ...
    return {
        ...
        detailCellRendererParams: {
          ...
          getDetailRowData: async (params) => {
            ...
            try {
              const result = await axios.post(
                variables.API_URL +
                  `/Api/OutputCases/export_documents?personlog_id=${personlog_id}`,
                {
                  ID_LIST:
      ...
      getDetailRowData: async (params) => {
        ...
        try {
          const result = await axios.post(
            variables.API_URL +
              `/Api/OutputCases/export_trans_docs?personlog_id=${personlog_id}`,
            {
              ID_LISTOFDOCLIST:
  ...
  return (
    <>
      ...
      />
      <Breadcrumb pageName="Исходящие дела" />
