...
const SuccessNotification = ({ isOpen, closeModal }) => {
        ...
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="max-w-[390px] w-full rounded-lg border border-[#227700] bg-[#C8FFB3] py-4 pl-4 pr-5.5 shadow-2 dark:border-[#3769FF] dark:bg-[#1B1B24]">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-grow items-center gap-5">
                      <div className="flex h-15 w-full max-w-15 items-center justify-center rounded-md bg-[#227700]">
                        <svg
                          width="32"
                          height="32"
                          viewBox="0 0 32 32"
                      ...
                      <div>
                        <h4 className="mb-0.5 text-title-xsm font-medium text-black dark:text-[#227700]">
                          Запрос выполнен
                        </h4>
