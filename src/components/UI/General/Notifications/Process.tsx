...
export default function ProcessNotification({ isOpen, closeModal }) {
        ...
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="max-w-[300px] w-full rounded-lg border border-[#3769FF] bg-[#E0E7FF] py-4 pl-4 pr-5.5 shadow-2 dark:border-[#3769FF] dark:bg-[#1B1B24]">
                  <div className="flex flex-grow items-center gap-5">
                    <div className="flex h-15 w-full max-w-15 items-center justify-center rounded-md bg-[#3769FF]">
                      <svg
                        width="32"
                        height="32"
                        viewBox="0 0 32 32"
                    ...
                    <div>
                      <h4 className="text-left mb-0.5 font-medium text-black dark:text-[#3769FF]">
                        Выполняется поиск
                      </h4>
