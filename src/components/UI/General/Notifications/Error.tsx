...
export default function ErrorNotification({ isOpen, closeModal, error }) {
        ...
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="max-w-[300px] w-full rounded-lg border border-[#F5C5BB] bg-[#FCEDEA] py-4 pl-4 pr-5.5 shadow-2 dark:border-[#EA4E2C] dark:bg-[#1B1B24]">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-grow items-center gap-5">
                      ...
                      <div>
                        <h4 className="mb-0.5 text-left text-title-xsm font-medium text-black dark:text-[#EA4E2C]">
                          Описание ошибки
                        </h4>
