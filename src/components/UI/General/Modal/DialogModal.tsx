  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="rounded-md py-2 px-4 text-sm text-white font-medium md:text-base lg:px-6 bg-primary hover:bg-primary hover:bg-opacity-65 dark:hover:bg-primary">
        {props.textbutton}
      </button>
