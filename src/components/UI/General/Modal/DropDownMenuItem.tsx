    ...
    <>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          <div
            className="fixed top-0 left-0 h-full min-h-screen w-full bg-black/90 px-4 py-5"
            aria-hidden="true"
          />
          <Transition.Child
            as={Fragment}
              ...
              <Transition.Child
                ...
                <Dialog.Panel className="w-full max-w-150 rounded-lg bg-white dark:bg-boxdark">
                  <ModalHeader>
                    ...
                    <button
                      type="button"
                      className="text-gray-400 bg-gray dark:bg-white/10 hover:bg-warning hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto dark:hover:bg-gray-600 dark:hover:text-white"
