...
const Sidebar = ({
  ...
  useEffect(() => {
    console.log(coreRoutes?.map((route) => route.path.split("/"))[1]);
  }, []);
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 shadow-2 flex h-screen w-[450px] flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-boxdark ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <!-- Прием и обработка деклараций --> */}
              {allowedUrls.has("/") ? (
                <li>
                  <NavLink
                    to="/"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-strokedark duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 dark:text-bodydark1 ${
                      pathname.includes("settings") &&
                      "bg-graydark1 dark:bg-meta-4"
                    }`}
                    ...
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/historyCorrection"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white" +
                                (isActive && "!text-black dark:!text-white")
                              }
                              onClick={() => setSidebarOpen(false)}>
                              История коррекции реестра нарушителей
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/exceptionsCorrection"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white" +
                                (isActive && "!text-black dark:!text-white")
                              }
                              onClick={() => setSidebarOpen(false)}>
                              Исключения из реестра нарушителей
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
              ...
              {/* <!-- Подсистема Реестры предприятий, реализующих алкогольную и спиртосодержащую продукцию --> */}
              <li>
                <NavLink
                  to="/Subjects"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-strokedark duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 dark:text-bodydark1 ${
                  ...
                  Реестр предприятий, реализующих алкогольную и спиртосодержащую
                  продукцию
                </NavLink>
              </li>
              {/* <!-- Menu Item Dashboard --> */}
              {/* <!-- Подсистема хранения и ведения единого реестра лицензий и лицензиатов --> */}
              <li>
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/" || pathname.includes("dashboard")
                    ...
                    return (
                      <React.Fragment>
                        <NavLink
                          ...
                          Подсистема хранения и ведения единого реестра лицензий
                          и лицензиатов
                          <svg
                            className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                              open && "rotate-180"
              ...
              <li>
                <NavLink
                  ...
                  Сведения о лицензиате, декларировании и объектах
                </NavLink>
              </li>
              <SidebarLinkGroup
                activeCondition={
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              onClick={() => setSidebarOpen(false)}>
                              Сведения о представлении деклараций
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              ...
                              onClick={() => setSidebarOpen(false)}>
                              Нарушители представления деклараций
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              ...
                              onClick={() => setSidebarOpen(false)}>
                              Загрузка файлов с отчетами РАТК
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              <li>
                <NavLink
                  to="/"
                  className={`hidden group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-strokedark duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 dark:text-bodydark1 ${
                    pathname.includes("tables") && "bg-graydark1 dark:bg-meta-4"
                  }`}>
                  <svg
                    className="fill-current"
                    width="18"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                ...
                {(handleClick, open) => {
                  if (
                    coreRoutes?.filter(
                      (route) =>
                        route.path.split("/")[1] === "okno" &&
                        allowedUrls.has(route.path)
                    ).length === 0
                  )
                    return null;
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-strokedark duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 dark:text-bodydark1 ${
                          (pathname === "/okno" || pathname.includes("auth")) &&
                          "bg-graydark1 dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          {allowedUrls.has("/okno/request-current-day") ? (
                            <li>
                              <NavLink
                                to="/licensing/exchange-fsrar"
                                className={({ isActive }) =>
                                  "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white " +
                                  (isActive && "!text-black dark:!text-white")
                                }>
                          ...
                          <li>
                            <NavLink
                              to="/licensing/caution-remains"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white " +
                                (isActive && "!text-black dark:!text-white")
                              }>
                              Предостережения об остатках
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/licensing/notice-goverment"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white " +
                                (isActive && "!text-black dark:!text-white")
                              }>
                              Уведомления в управы и префектуры
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/licensing/stop-notices-list"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white " +
                                (isActive && "!text-black dark:!text-white")
                              }>
                              Список приостановленных заявок
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/licensing/requests"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black dark:hover:text-white " +
                                (isActive && "!text-black dark:!text-white")
                              }>
              ...
              <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-strokedark duration-300 ease-in-out hover:bg-bodydark1 dark:hover:bg-meta-4 dark:text-bodydark1 ${
                    pathname.includes("chart") && "bg-graydark1 dark:bg-meta-4"
                  }`}>
                  <svg
                    className="fill-current"
                    width="18"
