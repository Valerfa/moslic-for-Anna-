...
const DefaultModal = ({ isOpen, closeModal }) => {
              ...
              >
                <Dialog.Panel className="w-full max-w-142.5 rounded-lg bg-white text-center dark:bg-boxdark">
                  <div className="flex items-center justify-between border-b border-stroke py-4 px-7 dark:border-strokedark">
                    ...
                    <button
                      type="button"
                      className="text-gray-400 bg-gray dark:bg-white/10 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
